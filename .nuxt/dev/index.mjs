globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Volumes/T7/Git/test-cc-main/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError } from 'file:///Volumes/T7/Git/test-cc-main/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///Volumes/T7/Git/test-cc-main/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Volumes/T7/Git/test-cc-main/node_modules/devalue/index.js';
import { renderToString } from 'file:///Volumes/T7/Git/test-cc-main/node_modules/vue/server-renderer/index.mjs';
...
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///Volumes/T7/Git/test-cc-main/node_modules/ufo/dist/index.mjs';
...
const _JdcMoiLmSV = (function(nitro) {
...
const _lazy_yYcvIH = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_yYcvIH, lazy: true, middleware: false, method: undefined },
...
const getClientManifest = () => import('/Volumes/T7/Git/test-cc-main/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/Volumes/T7/Git/test-cc-main/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
