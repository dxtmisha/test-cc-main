...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-f0f9b2ad.js").then((m) => m.default || m)
  },
  {
    name: "shop",
    path: "/shop",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-e4c9c418.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-404-e1d10ed9.js").then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-500-810d8f81.js").then((r) => r.default || r));
