...
const styles = {
  ...
  "pages/index.vue": () => import('./_nuxt/index-styles.b59f915f.mjs').then(interopDefault),
  "pages/shop/index.vue": () => import('./_nuxt/index-styles.df38cc0d.mjs').then(interopDefault)
};
